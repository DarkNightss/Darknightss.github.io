...
<html class='v2' dir='ltr' lang='vi' xmlns='http://www.w3.org/1999/xhtml' xmlns:b='http://www.google.com/2005/gml/b' xmlns:data='http://www.google.com/2005/gml/data' xmlns:expr='http://www.google.com/2005/gml/expr'>
    <head>
        <title>Nguyễn Xuân Khởi</title>
<link href='http://ngxuankhoi.herokuapp.com/image/profile-card.png' rel='icon' type='image/png'/>        
<meta content='width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0' name='viewport'/>
<link href='//file.leanhduc.pro.vn/image/favicon.png' rel='shortcut icon' type='image/x-icon'/>
<meta content='https://i.imgur.com/DwgFURz.png' property='og:image'/>
<meta content='http://ngxuankhoi.herokuapp.com/?/' property='og:url'/>
<meta content='website' property='og:type'/>
<meta content='Nguyễn Xuân Khởi' property='og:title'/>
<meta content='Xây dựng và phát triển bởi Nguyễn Xuân Khởi !' property='og:description'/>
...
<div class='profile-card__name'> Nguyễn Xuân Khởi <i class='fa fa-check-circle' style='color:rgb(17, 143, 249)' title='Verified Author'></i>
</div>
<div class='profile-card__txt'>Tôi là <b>Nguyễn Xuân Khởi</b>, một cậu sinh học sinh cấp 2 sắp lên cấp 3 chuyên <b>Tin học</b> với ước mơ trở thành một Developer chuyên nghiệp. Tôi thích khám phá, tìm tòi và học hỏi những điều thú vị trên mạng Internet.</i> ...</div>
<div class='profile-card-loc'>
<span class='profile-card-loc__icon'>
<svg class='icon'><use xlink:href='#icon-location'></use></svg>
</span>
<span class='profile-card-loc__txt'>Hà nội</span>
</div>
<div class='profile-card-inf'>
<div class='profile-card-inf__item'>
<div class='profile-card-inf__title' id='count-followers'>500</div>
...
<a class='profile-card-social__item facebook' href='https://www.facebook.com/NgXuan.Khoi/' target='_blank'>
<span class='icon-font'>
<svg class='icon'><use xlink:href='#icon-facebook'></use></svg>
</span>
</a>
<a class='profile-card-social__item link' href='https://www.facebook.com/NgXuan.Khoi/' target='_blank'>
<span class='icon-font'>
...
<button class='profile-card__button button--orange' onclick='window.open(&#39;https://www.facebook.com/NgXuan.Khoi/;)'>Follow</button>
</div>
</div>
<div class='profile-card-message js-message'>
<form class='profile-card-form'>
<div class='profile-card-form__container'>
<textarea placeholder='Cảm ơn bạn đã quan tâm. Nhấn vào nút Send để đến trang facebook của tôi. Chúc bạn một ngày tốt lành !'></textarea>
</div>
<div class='profile-card-form__bottom'>
<button class='profile-card__button button--blue' href='https://www.facebook.com/NgXuan.Khoi/'>Send</button>
<button class='profile-card__button button--gray'>Cancel</button>
</div>
</form>
...
<script type='text/javascript'>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                animateNumber(500, 5000, 0, function(number) {
